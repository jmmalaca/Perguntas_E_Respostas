...
public class DBHelper_Local extends SQLiteOpenHelper {
	...
	private static final String DEBUG_TAG = "( DBHelper_Local ) DEBUG";
	...
	DBHelper_Local(Context context) {
		super(context, DATABASE_NAME_LOCAL, null, DATABASE_VERSION);
		System.out.println(DEBUG_TAG + " builder called ");
	}

	@Override
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE " + DATABASE_NAME_LOCAL
